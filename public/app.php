    ...
    <div class="row">
        <div class="col-12">
            ...
            <table class="table">
                ...
                <tr><th>Path</th> <th>Filename</th> <th>Download</th><?php /* <th>Delete</th>*/ ?></tr>
                </thead>
                <tbody>
                    <?php foreach ($bucket_contents as $bucket_content): ?>
                        <tr>
                            ...
                            <td> <a href="<?= $storage->getUrl($bucket_content['Key']) ?>" target="_blank">Download</a> </td>
                            <?php /* <td><a href="?delete=<?= $bucket_content['Key'] ?>">Delete</a> </td> */ ?>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
